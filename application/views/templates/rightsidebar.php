        ...
        <div id="chatapp" class="col s12">
          <div class="collection border-none">
            <a href="#!" class="collection-item avatar border-none">
              <img src="<?php echo asset_url();?>images//avatar/avatar-1.png" alt="" class="circle cyan">
            ...
            <a href="#!" class="collection-item avatar border-none">
              <img src="<?php echo asset_url();?>images//avatar/avatar-1.png" alt="" class="circle deep-orange accent-2">
            ...
            <a href="#!" class="collection-item avatar border-none">
              <img src="<?php echo asset_url();?>images//avatar/avatar-1.png" alt="" class="circle teal accent-4">
